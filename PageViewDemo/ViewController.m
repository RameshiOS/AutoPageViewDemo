...
//
    ...
    /*! setup an interval */
   timerI = [NSTimer scheduledTimerWithTimeInterval:3.0
                                     target:self
    ...
    NSArray *startingViewControllers = @[[self  viewControllerAtIndex:currentIndex]];
...
- (IBAction)startActionClicked:(id)sender {
//    PageContentViewController *startingViewController = [self viewControllerAtIndex:0];
//  
//    NSArray *viewControllers = @[startingViewController];
